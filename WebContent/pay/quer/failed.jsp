    ...
    <div class="content">
            <div class="container">    
                <div class="success-body" style="text-align: center">
                    ...
                    <h1>Oh Snap!</h1>
                    <p class="lead">Your transaction was not successful.
                    </p>
                   	 <h1 class="page-section-heading"><i class="fa fa-credit-card"></i> Payment Failed</h1>
                    <div class="panel panel-default">
                        <div class="panel-body">   
                        <img src="http://alpha.school/assets/img/notok.jpg" alt="payment failed" />              
						<h1>${callback.body.ResponseCode}</h1>
						<p>Reason: ${callback.body.ResponseDescription}</p>
						<p>Transaction reference: ${dola}</p>
